...
st.markdown(
    ...
    <style>
    .stApp {
        background-image: url("https://www.ny-engineers.com/hubfs/Blog%20Images/What-Are-the-6-Main-Greenhouse-Gases.jpg");
...
st.markdown('<h1 class="main-title">Supply Chain Emissions Prediction</h1>', unsafe_allow_html=True)
st.markdown(
    '<h4 class="main-desc">This app predicts Supply Chain Emission Factors with Margins based on DQ metrics and other parameters.</h4>',
    unsafe_allow_html=True
)
